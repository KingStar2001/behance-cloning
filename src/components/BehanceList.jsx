...
const BehanceList = () => {
  ...
  const [likedImages, setLikedImages] = useState({
    "https://images.unsplash.com/photo-1478144592103-25e218a04891?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDEyfHxuYXR1cmV8ZW58MHx8fHwxNjg3MDk1MDcw&ixlib=rb-4.0.3&q=80&w=400": false,
    "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDI4fHxuYXR1cmV8ZW58MHx8fHwxNjg3MDk1MDcw&ixlib=rb-4.0.3&q=80&w=400": false,
 ...
 return (
    ...
    <div className="absolute inset-y-0 left-0 w-1/2 flex flex-col justify-center items-center pr-80 mt-40">
  ...
  <div className="absolute inset-y-0 left-0 w-1/2 flex flex-col justify-center items-center ">
  <div className="flex flex-col items-center">
  ...
  <div className="absolute inset-y-0 right-0 w-1/2 flex flex-col justify-center items-center pl-80 mt-40">
    <div className="flex flex-col items-center">
  ...
  <div className="mt-8 flex space-x-4">
    ...
    <button className="border border-blue-500 text-blue-500 px-6 py-3 text-lg rounded">
      Try Behance Pro
    </button>
  </div>
              </section>
        ...
        <div className="flex flex-wrap -m-4">
          {images.map((image, index) => (
            <div key={index} className="xl:w-1/4 md:w-1/3 p-4">
              <div className="bg-gray-100 p-6 rounded-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
                <img
                ...
                />
                <h3 className="tracking-widest text-indigo-500 text-xs font-medium title-font">{image.subtitle}</h3>
